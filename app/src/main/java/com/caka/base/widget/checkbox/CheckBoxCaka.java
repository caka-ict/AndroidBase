package com.caka.base.widget.checkbox;
...
public class CheckBoxCaka  extends View implements Checkable {

    private static final String TAG = CheckBoxCaka.class.getSimpleName();
    ...
    public CheckBoxCaka(Context context) {
        super(context);
    }

    public CheckBoxCaka(Context context, AttributeSet attrs) {
        super(context, attrs);
        mPaint = new Paint();

        if(attrs != null){
            TypedArray array = getContext().obtainStyledAttributes(attrs, R.styleable.CheckBoxCaka);
            int colorAfter = array.getColor(R.styleable.CheckBoxCaka_color_after, Color.GRAY);
            int colorBefore = array.getColor(R.styleable.CheckBoxCaka_color_before,Color.GRAY);
            ...
            boxText = array.getString(R.styleable.CheckBoxCaka_check_text);
            isHook = array.getInt(R.styleable.CheckBoxCaka_check_style, 1) == 1;
            isShowBorder = array.getBoolean(R.styleable.CheckBoxCaka_show_border,false);
            isCircle = array.getBoolean(R.styleable.CheckBoxCaka_is_circle_border,true);
...
//        mPaintText.setStrokeWidth(strokeWidth);
    ...
    public CheckBoxCaka(Context context, AttributeSet attrs, int defStyleAttr) {
